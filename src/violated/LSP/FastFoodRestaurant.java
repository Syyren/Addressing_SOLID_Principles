...
public class FastFoodRestaurant extends RestaurantWaitTime
{
    //function that runs the restaurant using function defined in the restaurant wait time parent class
